...
public class WaterWaves2D:MonoBehaviour{
	...
	public uint renderingLayerMask = 0;
	...
	public void BuildMesh(bool onlyVertices){
		...
		if(!onlyVertices){
			...
			if(mr!=null){
				...
				mr.renderingLayerMask = renderingLayerMask;
			}
		}
	}
	...
	public void PlayEnterSound(){ 
		if(enterSounds!=null) PlayClip(enterSounds[Random.Range(0,enterSounds.Length)]);
	}

	public void PlayExitSound(){ 
		if(exitSounds!=null) PlayClip(exitSounds[Random.Range(0,exitSounds.Length)]);
	}
